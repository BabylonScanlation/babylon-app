...
class GeneralOptions:
    ...
    def create_page(self) -> QWidget:
        ...
        lang_group.setStyleSheet("background-color: rgba(30, 30, 30, 100);")
...
class DisplayOptions:
    ...
    def __init__(self, controller: 'OptionsController'):
        ...
        self.fullscreen_cb.stateChanged.connect(lambda: controller.toggle_fullscreen())
...
class AudioOptions:
    ...
    def __init__(self, controller: 'OptionsController'):
        ...
        self.vol_slider.valueChanged.connect(controller.adjust_volume)

        self.music_local_btn = QPushButton("Cargar archivo local")
        self.music_local_btn.clicked.connect(controller.load_local_music)
        ...
        self.music_url_btn.clicked.connect(
            lambda: controller.load_music_from_url(self.music_url_input.text())
        )
    ...
    def create_page(self) -> QWidget:
        ...
        music_group.setStyleSheet("background-color: rgba(30, 30, 30, 100);")
...
class VideoOptions:
    ...
    def __init__(self, controller: 'OptionsController', options_menu: 'OptionsMenu'):
        self.controller = controller
        self.options_menu = options_menu
        self.video_local_btn = QPushButton("Seleccionar video local")
        self.video_local_btn.clicked.connect(controller.load_local_video)
        ...
        self.video_url_btn.clicked.connect(
            lambda: controller.load_video_from_url(self.video_url_input.text())
        )
    ...
    def create_page(self) -> QWidget:
        ...
        video_group.setStyleSheet("background-color: rgba(30, 30, 30, 100);")
...
class ImageOptions:
    ...
    def __init__(self, controller: 'OptionsController'):
        ...
        self.image_local_btn.clicked.connect(controller.load_local_image)
        ...
        self.image_url_btn.clicked.connect(
            lambda: controller.load_image_from_url(self.image_url_input.text())
        )
    ...
    def create_page(self) -> QWidget:
        ...
        image_group.setStyleSheet("background-color: rgba(30, 30, 30, 100);")
...
class MiscOptions:
    ...
    def __init__(self, controller: 'OptionsController'):
        ...
        self.bg_type_combo.currentTextChanged.connect(controller.handle_bg_type_change)
        ...
        self.music_with_image_cb.stateChanged.connect(
            controller.toggle_music_with_image
        )
    ...
    def create_page(self) -> QWidget:
        ...
        bg_type_group.setStyleSheet("background-color: rgba(30, 30, 30, 100);")
...
class OptionsMenu:
    ...
    def create_options_area(self) -> QWidget:
        """Crea un área de opciones con diseño Cyber-Glass coherente."""
        options_widget = QWidget(self.parent.content_container)
        options_widget.setObjectName("OptionsMainPanel")
        ...
        for cat, tooltip in categories:
            ...
            btn.clicked.connect(lambda checked=False, c=cat: self._show_option_page(c))
            btn.setStyleSheet(
                """
            QPushButton {
    ...
    def _show_option_page(self, category: str):
